...
public class CartServiceImpl implements CartService {
    ...
    public Cart findCartByUserAndProduct(String userId, String productId) {
        ...
        try {
            return cartDao.findCartByProductIdAndUserId(productId, userId);
        } catch (Exception e) {
    ...
    public void save(Cart cart) {
        ...
        try {
            ...
            Cart existingCartItems = cartDao.findCartByProductIdAndUserId(cart.getProductId(), cart.getUserId());
